...
@Component({
  selector: 'app-xitypay',
  templateUrl: './xitypay.component.html',
  styleUrls: ['./xitypay.component.css']
})
export class XitypayComponent extends CrudImpl implements OnInit {
  ...
  override incluir(): void {
    ...
    if (this.form.status === 'VALID'){
      ...
      xpCuenta.vigente_por = Math.round(parseFloat(this.form.get('vigente_por')?.value) * 60)
  ...
  setXpayCuenta(xpayCta:XpayCuenta):void{
    ...
    this.form.patchValue({
      ...
      vigente_por: xpayCta.vigente_por? xpayCta.vigente_por / 60:60
    })
    ...
    if (this.form.value.texto_5 == null || this.form.value.texto_5 == undefined || this.form.value.texto_5 == '') {
      // this.form.patchValue({
      //   texto_5:this.emailString
      // })
    }
    ...
    .afterClosed().subscribe(result=>{
      if(result){
        ...
        this.form.patchValue({
          plan_cuenta:{
            id_plan: "PC1",
            comision_ent_banco: 0,
            comision_sal_banco: 0,
            comision_sal_otro_banco: 0,
            comision_xp: 0,
            nombre: "Plan C1",
